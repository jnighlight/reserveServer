...
INSERT INTO `course` VALUES (6,5,'DateCourse 102','dateEamil@emaeeil.ede','2014-02-01','2014-02-28','01:00:00','02:30:00',1,0,1,0,1),(7,5,'Motorcycle Jupming','jupman@jump.com','2014-01-24','2014-03-31','12:00:00','13:00:00',0,1,0,1,0);
...
INSERT INTO `room_reservation_permission` VALUES (1,6),(2,7),(1,5),(2,5),(3,5);
...
INSERT INTO `user` VALUES (1,'mburton1@stetson.edu','password','Mark','Burton','77',1,'?S9?zV?\n?n?a{	??~?q???????V?r \r??f~P?|9???tG?-??\0/?&?Y??#\'I??+p?.??ku?[?!???=?k??c?m???DTz????b??(#?','55'),(2,'jlites@stetson.edu','password','Jacob','Lites','680',1,'G?S[c??O???=????44?fS?W@?????:???? ???F?84?\0????p?/??|?FUa`\Z?-???e??\0??(?8_r?3?T\ZUs?q??????|????^C???x=????1?3??C?=o?','097'),(3,'wurkstudee@stetson.edu','password','Sally','Workstudy','555-867-5309',0,'','800555555'),(4,'email@email.email','password','Black','one','324324141',0,'','23141324'),(5,'blah@blah.blah','password','Blank','two','1324',0,'','1234'),(6,'ajdsfl@adfslj.com','asdf','Blank','Three','1234',0,'','12345'),(7,'asdf@adf.qwer','adsf','adsf','asdf','12341234',0,'','12341324'),(8,'wqer@aef.adsf','asdf','asdfgas','agasdgdsf','154135',0,'','125313'),(9,'ajsdf@adfsjk.afj','ASDF','asjdfk','sajdf','31424313',0,'','1234342141'),(10,'lol@laol.com','ASDF','ASD','ASDF','341234123',0,'','31241234'),(11,'oeiwqroieqwrui@ieoiqr.com','pass','asdfadsf','muthertrucker','6444',0,'','4656546');
...
-- Dump completed on 2014-02-28  2:37:43
